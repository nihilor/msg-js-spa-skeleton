...
___config.package___.ctrl = cs.trait({
    protos: {
        ...
        setup () {
            ...
            this.subscribeDataService("readProjects", function (result) {
            ...
            this.subscribeDataService("createProject", function (project, result) {
                // IMPORT the loaded data in the datamanager
                /*if (project.id) {
            ...
            this.subscribeDataService("updateProject", function (project, result) {
                // (RE-) IMPORT the loaded data in the datamanager
                //return app.util.EntityCreateUtil.importWorkGroup(project.id, result);
                return result;
            });

            this.subscribeDataService("deleteProject", function (/*project*/) {
